...
void test('intro starts without cards and with wireframe',()=>{
...
void test('lines draw before a card becomes visible',()=>{
...
void test('paired cards stagger, reverse deterministically and persist at the end',()=>{
...
void test('timeline and zoom clamp invalid and out-of-bounds values',()=>{
...
void test('card exits before its connector retracts, content enters after shell',()=>{
...
void test('mobile cards fade out and in around their handover',()=>{
