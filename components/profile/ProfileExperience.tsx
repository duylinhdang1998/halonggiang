...
export default function ProfileExperience() {
 ...
 const rotate=(delta:number)=>setRotation(value=>value+delta);
 const resetView=()=>{setZoom(1);setRotation(0);setResetKey(value=>value+1);};
 ...
 return <main ref={root} className="scroll-experience" id="noi-dung">
   <div className="scroll-stage" data-progress={progress.toFixed(3)}>
     ...
     <CharacterStage progress={reveal} zoom={zoom} rotation={rotation} resetKey={resetKey} onRotate={rotate} onAnchors={updateAnchors}/>
     ...
     <SceneControls zoom={zoom} onZoom={setZoom} onRotate={rotate} onReset={resetView}/>
